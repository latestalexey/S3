 ...
 * @return {undefined}
 */
export function deleteBucket(bucketMD, bucketName, authInfo, log, cb) {
    log.trace('deleting bucket from metadata');
    assert.strictEqual(typeof bucketName, 'string');
    assert.strictEqual(typeof authInfo.getCanonicalID(), 'string');
    ...
    return async.waterfall([
        ...
        function deleteUserBucketEntryStep(next) {
            ...
            return _deleteUserBucketEntry(bucketName, authInfo.getCanonicalID(),
                log, next);
        },
    ],
